...
public class MainFrame extends JFrame implements UserInterface {
     ...
     */
    @Override
    public void printBoard(final org.IgorNorbert.lista4.Color[][] board) {
        if (lobbies != null) {
            this.remove(lobbies);
            lobbies = null;
        }
     ...
     */
    @Override
    public void setCurrentPlayer(final org.IgorNorbert.lista4.Color color) {
     ...
     */
    @Override
    public void setPlayerColor(final org.IgorNorbert.lista4.Color color) {
    ...
    public void printPlayers(
            final Map<String, org.IgorNorbert.lista4.Color> playerMap) {
        if (playerMap == null) {
            return;
        }
