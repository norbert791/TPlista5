...
public class MainFrame extends JFrame implements UserInterface {
     ...
     */
    @Override
    public void printBoard(final org.Norbert.lista4.Game.Color[][] board) {
        if (lobbies != null) {
            this.remove(lobbies);
            lobbies = null;
        }
     ...
     */
    @Override
    public void setCurrentPlayer(final org.Norbert.lista4.Game.Color color) {
     ...
     */
    @Override
    public void setPlayerColor(final org.Norbert.lista4.Game.Color color) {
    ...
    public void printPlayers(
            final Map<String, org.Norbert.lista4.Game.Color> playerMap) {
        if (playerMap == null) {
            return;
        }
     ...
     */
    public org.Norbert.lista4.Game.Color getCurrentPlayerColor() {
     ...
     */
    public org.Norbert.lista4.Game.Color getPlayerColor() {
        return playerColor;
    }
     ...
     */
    protected Color translateColor(org.Norbert.lista4.Game.Color playerColor) {
        if (playerColor == null) {
            return Color.WHITE;
        }
