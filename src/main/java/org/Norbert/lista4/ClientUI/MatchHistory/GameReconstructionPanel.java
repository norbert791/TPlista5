package org.Norbert.lista4.ClientUI.MatchHistory;

import org.Norbert.lista4.ClientUI.GamePanel;
...
public class GameReconstructionPanel extends JPanel { //TODO: Merge with gamePanel
    ...
    public GameReconstructionPanel(GameRecord record) {
        ...
        org.Norbert.lista4.Game.Color[][] board = record.initialBoard();
     ...
     */
    private Color translateColor(org.Norbert.lista4.Game.Color playerColor) {
        if (playerColor == null) {
            return Color.WHITE;
        }
