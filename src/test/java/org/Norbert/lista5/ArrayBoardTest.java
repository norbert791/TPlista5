...
import org.Norbert.lista5.Game.*;
...
public class ArrayBoardTest {
    ...
    public void putAndGetCheckerTest(){
        ...
        assertDoesNotThrow(() -> assertEquals(board.getCheckerColor(rightCoordinates[0], rightCoordinates[1]),
    ...
    public void moveCheckerTest(){
        ...
        Assertions.assertDoesNotThrow(() -> board.moveChecker(
                10,12,11,13));
        assertDoesNotThrow(()-> board.addChecker(
    ...
    public void checkMoveReturn(){
        ...
        try{
            ...
            assertTrue(board.moveChecker(2,4,4,6), "True should be returned");
            assertFalse(board.moveChecker(4, 6 , 6, 8), "False should be returned");
        }
